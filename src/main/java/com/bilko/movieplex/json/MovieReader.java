...
public class MovieReader implements MessageBodyReader<Movie> {
    ...
    @Override
    public boolean isReadable(final Class<?> movie, final Type type, final Annotation[] annotations,
        final MediaType mediaType) {
        return Movie.class.isAssignableFrom(movie);
    }

    @Override
    public Movie readFrom(final Class<Movie> object, final Type type, final Annotation[] annotations,
