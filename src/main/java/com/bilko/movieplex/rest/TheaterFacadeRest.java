...
public class TheaterFacadeRest extends AbstractFacade<Theater> {
    ...
    public void create(final Theater theater) {
    ...
    @Override
    @Consumes({"application/xml", "application/json"})
    public void edit(final Theater theater) {
        super.edit(theater);
    }
    ...
    public Theater find(@PathParam("id") final Integer id) {
    ...
    @Path("{from}/{to}")
    @Produces({"application/xml", "application/json"})
    public List<Theater> findRange(@PathParam("from") final Integer from, @PathParam("to") final Integer to) {
