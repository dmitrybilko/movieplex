...
public class ShowTimingFacadeRest extends AbstractFacade<ShowTiming> {
    ...
    public void create(final ShowTiming timing) {
        super.create(timing);
    }
    ...
    @Consumes({"application/xml", "application/json"})
    @Path("{id}")
    public void edit(final ShowTiming timing) {
        super.edit(timing);
    }
    ...
    public ShowTiming find(@PathParam("id") final Integer id) {
    ...
    @Path("{from}/{to}")
    @Produces({"application/xml", "application/json"})
    public List<ShowTiming> findRange(@PathParam("from") final Integer from, @PathParam("to") final Integer to) {
